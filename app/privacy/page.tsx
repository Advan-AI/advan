      ...
      <main className="pt-20">
        <section className="py-24 pt-32">
          <div className="max-w-3xl mx-auto px-6">
            <h1 className="text-4xl font-semibold tracking-tight text-gradient mb-4">Privacy Policy</h1>
            <p className="text-white/55 mb-10 text-sm">Last updated: January 2026</p>

            <div className="prose prose-lg prose-invert max-w-none space-y-10">
              <section>
              ...
              <section>
                ...
                <p className="text-white/70 leading-relaxed mb-4">Depending on your location, you may have certain rights regarding your personal information, including:</p>
                <ul className="list-disc pl-6 space-y-2 text-white/70">
